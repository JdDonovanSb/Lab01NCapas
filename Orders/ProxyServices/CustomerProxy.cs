...
namespace ProxyService
{
    public class CustomerProxy : ICustomerProxy
    {
        ...
        public CustomerProxy()
        {
            ...
            {
                BaseAddress = new Uri("https://localhost:7054/api/Customer/") // Asegúrate de que esta URL coincida con la configuración de tu servicio (es el puerto de local host de Swagger)
            };
